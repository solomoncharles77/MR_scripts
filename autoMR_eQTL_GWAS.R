...
option_list = list(
  ...
  make_option(c("-c", "--cand"), type="character", default=NULL, 
              help="Candidate gene or probe to be used as exposure e.g ENSG00000001460", metavar="character"),
...
#expoFileName <- "../pubAvail_QTL/GTEx/eQTL_catalogue/QTD000131_GTExartery_aorta_pval005.tsv.gz"
...
eGene$Phenotype <- expID
gwas1_match <- eGene[, c("snps", "rsid", "alt", "ref", "maf", "pvalue", "beta", "se", "n", "Phenotype")]
colnames(gwas1_match) <- c("hg38_markername", "SNP", "effect_allele","other_allele","eaf", "pval", "beta", "se", "samplesize", "Phenotype")
