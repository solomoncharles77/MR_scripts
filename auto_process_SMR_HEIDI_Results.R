...
if (dim(smr3)[1] != 0) {
  #manhattan plot
  png(filename = paste0("/scratch/vasccell/cs806/SCAD/smrResults/manhattanPlots/", aha2, "_SMRHEIDImanhattan.png"))
  ...
  write.csv(smr2, paste0("/scratch/vasccell/cs806/SCAD/smrResults/resultTables/", aha2, ".csv"), row.names = F)
  write.csv(smr4, paste0("/scratch/vasccell/cs806/SCAD/smrResults/resultTables/", aha2, "_sig_p_HEIDI.csv"), row.names = F)
  write.csv(smr5, paste0("/scratch/vasccell/cs806/SCAD/smrResults/resultTables/", aha2, "_sig_p_SMR.csv"), row.names = F)
