...
#gwas2 <- data.frame(fread("/scratch/vasccell/cs806/colocalization/cleanGWAS_Summary_Stats/GWAS_Progesterone_Females_Eur_Pott_2022_Metabolites_hg38.txt_hg38.txt"))
...
# Reformat
exposure_dat <- format_data(gwas2_match, type = "exposure")
outcome_dat <- format_data(gwas1_match, type = "outcome")
...
dat_clump2 <- ld_clump(
  ...
  clump_r2 = 0.1,
  bfile = "/lustre/alice3/scratch/vasccell/cs806/colocalization/1000Genome/euroSamps1kGMerge",
  plink_bin = genetics.binaRies::get_plink_binary()
)

dat_clump3 <- ld_clump_local(
  dplyr::tibble(rsid=dat$SNP, pval=dat$pval.exposure, id=dat$exposure),
  clump_r2 = 0.1,
  clump_p = 0.00005,
  clump_kb = 10000,
...
# 
# dat_clump4 <- ld_matrix(
#   dplyr::tibble(rsid=dat$SNP),
#   bfile = "/lustre/alice3/scratch/vasccell/cs806/colocalization/1000Genome/euroSamps1kGMerge",
#   plink_bin = genetics.binaRies::get_plink_binary()
# )
