...
option_list = list(
  ...
  make_option(c("-p", "--pcutexp"), type="numeric", default = 5e-02, 
...
gwas2_sig <- gwas2_sig[, c("hg38_markername", "permID", "ALT", "REF", "eaf", "pvalue", "beta", "se", "n")]
colnames(gwas2_sig) <- c("hg38_markername", "SNP", "effect_allele","other_allele","eaf", "pval", "beta", "se", "samplesize")

# Harmonize
gwas1_match <- gwas1_sig[gwas1_sig$SNP %in% gwas2_sig$SNP, ]
gwas2_match <- gwas2_sig[gwas2_sig$SNP %in% gwas1_sig$SNP, ]
